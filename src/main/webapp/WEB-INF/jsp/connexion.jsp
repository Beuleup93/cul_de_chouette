...
<body>
	...
	<div class="container">
		...
		<h6 style="align-content: center;color:red;font-family: 'Times New Roman';"><c:out value="${error}" /></h6>
	</div>
	<div class="container card">
		<div class="card-header">
			<h4 align="center"> Veuillez vous authentifiez</h4>
		</div>
		<div class="card-body">
			<div classe="col-md-10 offset-3">
				<form method="Post" action="JoueurServletSecondaire">
					<div class="form-group col-md-5 offset-3">
						...
						<input type="text" class="form-control" name="pseudonyme" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Pseudo">
					</div>
					<div class="form-group col-md-5 offset-3">
					...
					<div class="form-check col-md-5 offset-3">
						<input type="hidden" class="btn btn-primary" name="connexion" value="connexion"/>
